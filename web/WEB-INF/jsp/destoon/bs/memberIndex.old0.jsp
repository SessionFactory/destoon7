...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <link rel="web-socket" href="wss://live.github.com/_sockets/MTY3MTIzMzI6ZTg3MTBiZjc3YTI3YjM3YmU3ODYyYTFmYmYyZmM4YTc6N2QzZmQwOGE1MGRkODE5YmJiNzQ5M2ViZWU5NTdhM2E3YTBjMjUzYmQyMTE1NDE2Y2ZiYjhjOTQyMzcyMDE3Ng==--ea381f05076f056a88b7b026ceb75715608dffd0">
    <meta name="pjax-timeout" content="1000">
    <link rel="sudo-modal" href="/sessions/sudo_modal">
    <meta name="request-id" content="73EEF1C3:14AEE:225B1939:583A5678" data-pjax-transient>
    ...
    <meta content="73EEF1C3:14AEE:225B1939:583A5678" name="octolytics-dimension-request_id"/>
    <meta content="16712332" name="octolytics-actor-id"/>
    <meta content="SessionFactory" name="octolytics-actor-login"/>
    <meta content="d1d19035aa5bbeb8d6ded91e837bb3eae45e8b9a7690f10b7b5dbd8a69c8cc0b" name="octolytics-actor-hash"/>
    ...
    <meta name="user-login" content="SessionFactory">

    <meta name="expected-hostname" content="github.com">
    <meta name="js-proxy-site-detection-payload" content="">


    <link rel="mask-icon" href="https://assets-cdn.github.com/pinned-octocat.svg" color="#000000">
    <link rel="icon" type="image/x-icon" href="https://assets-cdn.github.com/favicon.ico">

    <meta name="html-safe-nonce" content="12f4305c69c4588b93351777be4fa4d26b9d9842">
    <meta content="cd37fc6aa251d508e6dfb4fbc595d8f15f483680" name="form-nonce"/>

    <meta http-equiv="x-pjax-version" content="6b67469695dca00bd0736dc07efc5838">


    <link href="/SessionFactory.private.atom?token=AP8CjK0zOS1SjpsKGpjY3zjw41eV_EnKks62Rjd4wA==" rel="alternate" title="ATOM" type="application/atom+xml"/>
                  ...
                  <li class="header-nav-item dropdown js-menu-container">
                      ...
                      <div class="dropdown-menu-content js-menu-content">
                          <div class="dropdown-menu dropdown-menu-sw">
                              ...
                              <a class="dropdown-item" href="/SessionFactory" data-ga-click="Header, go to profile, text:your profile">
                                  Your profile
                              </a>
                              <a class="dropdown-item" href="/SessionFactory?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">
                                  Your stars
                              </a>
                              ...
                              <!-- '"` --><!-- </textarea></xmp> --></option></form>
                              <form accept-charset="UTF-8" action="/logout" class="logout-form" data-form-nonce="cd37fc6aa251d508e6dfb4fbc595d8f15f483680" method="post">
                                  <div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;"/><input name="authenticity_token" type="hidden" value="o7/dQuSg5p5Fta0zMO7BNaZhZLwTrI8lQoarSujKaFa7+2SQBTioFNuwW5rKJTeqeURCeeEjg5sLLqvtYsA4IA=="/></div>
...
<span class="select-menu-item-text">
  SessionFactory
                                        ...
                                        <%--                        <a href="/orgs/AngusTungPHP/dashboard" role="menuitem" class="select-menu-item js-navigation-item js-navigation-open" data-ga-click="Dashboard, switch context, Switch dashboard context from:user to:organization">
                                                        <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12">
                                                            <path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/>
                                                        </svg>
                                                        <div class="select-menu-item-gravatar">
                                                            <img alt="@AngusTungPHP" height="20" src="https://avatars0.githubusercontent.com/u/23289431?v=3&amp;s=40" width="20"/>
                                                        </div>
                                            <span class="select-menu-item-text">
                                              AngusTungPHP
                                            </span>
                                                                    </a>
                                          <a href="/orgs/tongange/dashboard" role="menuitem" class="select-menu-item js-navigation-item js-navigation-open" data-ga-click="Dashboard, switch context, Switch dashboard context from:user to:organization">
                                              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12">
                                                  <path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/>
                                              </svg>
                                              <div class="select-menu-item-gravatar">
                                                  <img alt="@tongange" height="20" src="https://avatars0.githubusercontent.com/u/22161219?v=3&amp;s=40" width="20"/>
                                                                        </div>
                                            <span class="select-menu-item-text">
                                              tongange
                                            </span>
                                                                    </a>
                                            <a href="/orgs/tongangeJava/dashboard" role="menuitem"
                                               class="select-menu-item js-navigation-item js-navigation-open"
                                               data-ga-click="Dashboard, switch context, Switch dashboard context from:user to:organization">
                                                <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12">
                                                                <path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/>
                                                            </svg>
                                                            <div class="select-menu-item-gravatar">
                                                                <img alt="@tongangeJava" height="20" src="https://avatars3.githubusercontent.com/u/23326248?v=3&amp;s=40" width="20"/>
                                                            </div>
                                                        <span class="select-menu-item-text">
                                                          tongangeJava
                                                        </span>
                ...
                <div class="dashboard-sidebar column one-third">
                    ...
                    <div class="octofication js-notice">
                        <div class="message">
                            <!-- '"` --><!-- </textarea></xmp> --></option></form>
    <form accept-charset="UTF-8" action="/account/read_broadcast/2267" class="notice-dismiss js-notice-dismiss" data-form-nonce="cd37fc6aa251d508e6dfb4fbc595d8f15f483680" data-remote="true" method="post">
        <div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;"/><input name="_method" type="hidden" value="put"/><input name="authenticity_token" type="hidden" value="rYzTN1fd0hruMnKDL+UXwVLtuW20EJlk9tGtFBVs5mu1yGrltkWckHA3hCrVLuFejcifqEafldq/ea2zn2a2HQ=="/></div>
        <button
                type="submit"
                class="close-button"
                data-ga-click="Dashboard, dismiss broadcast, Introducing GitHub Community Guidelines"
                data-ga-load="Dashboard, load broadcast, Introducing GitHub Community Guidelines">
    ...
    <div class="broadcast-icon">
        <svg aria-hidden="true" class="octicon octicon-radio-tower" height="32" version="1.1" viewBox="0 0 16 16" width="32">
                                    <path fill-rule="evenodd"
                            ...
                            <h3><a href="/blog/2267-introducing-github-community-guidelines" data-ga-click="Dashboard, read broadcast, Introducing GitHub Community Guidelines">Introducing GitHub Community Guidelines</a></h3>
                            <p>We want the GitHub community to be a welcoming environment where people feel empowered to share their opinion. We are now accepting feedback on our proposed Community Guidelines. </p>
                        </div>
                        <div class="octofication-more">
                            <a href="/blog/broadcasts">
                                View all broadcasts
                            </a>
                        </div>
                    </div>
        ...
        <svg aria-label="stars" class="octicon octicon-star" height="16" role="img" version="1.1" viewBox="0 0 14 16" width="14">
            <path fill-rule="evenodd" d="M14 6l-4.9-.64L7 1 4.9 5.36 0 6l3.6 3.26L2.67 14 7 11.67 11.33 14l-.93-4.74z"/>
                                ...
                                <%--  <li class="public source no-description">
                                      <a href="/tongange/SITC7" class="mini-repo-list-item css-truncate" data-ga-click="Dashboard, click, Popular repos list item - context:user visibility:public fork:false">
                                          <svg aria-label="Repository" class="octicon octicon-repo repo-icon" height="16" role="img" version="1.1" viewBox="0 0 12 16" width="12">
                                      ...
                                      <span class="repo-and-owner css-truncate-target">
                                        <span class="owner css-truncate-target" title="tongange">tongange</span>/<span class="repo" title="SITC7">SITC7</span>
                                      </span>
                                      <span class="stars">
                                        0
                                        <svg aria-label="stars" class="octicon octicon-star" height="16" role="img" version="1.1" viewBox="0 0 14 16" width="14">
                                ...
                                <%--   <li class="public source ">
                                       <a href="/AngusTungPHP/yyPHP" class="mini-repo-list-item css-truncate" data-ga-click="Dashboard, click, Popular repos list item - context:user visibility:public fork:false">
                                           <svg aria-label="Repository" class="octicon octicon-repo repo-icon" height="16" role="img" version="1.1" viewBox="0 0 12 16" width="12">
                                               <path fill-rule="evenodd" d="M4 9H3V8h1v1zm0-3H3v1h1V6zm0-2H3v1h1V4zm0-2H3v1h1V2zm8-1v12c0 .55-.45 1-1 1H6v2l-1.5-1.5L3 16v-2H1c-.55 0-1-.45-1-1V1c0-.55.45-1 1-1h10c.55 0 1 .45 1 1zm-1 10H1v2h2v-1h3v1h5v-2zm0-10H2v9h9V1z"/>
                                                                        </svg>
                                      <span class="repo-and-owner css-truncate-target">
                                        <span class="owner css-truncate-target" title="AngusTungPHP">AngusTungPHP</span>/<span class="repo" title="yyPHP">yyPHP</span>
                                      </span>
                                      <span class="stars">
                                        0
                                        <svg aria-label="stars" class="octicon octicon-star" height="16" role="img" version="1.1" viewBox="0 0 14 16" width="14">
                                            <path fill-rule="evenodd" d="M14 6l-4.9-.64L7 1 4.9 5.36 0 6l3.6 3.26L2.67 14 7 11.67 11.33 14l-.93-4.74z"/>
                                                                ...
                                                                <li class="public source no-description">
                                                                    <a href="/tongange/JavaEE7Tools.2016.10" class="mini-repo-list-item css-truncate" data-ga-click="Dashboard, click, Popular repos list item - context:user visibility:public fork:false">
                                                                        <svg aria-label="Repository" class="octicon octicon-repo repo-icon" height="16" role="img" version="1.1" viewBox="0 0 12 16" width="12">
                                                                            <path fill-rule="evenodd" d="M4 9H3V8h1v1zm0-3H3v1h1V6zm0-2H3v1h1V4zm0-2H3v1h1V2zm8-1v12c0 .55-.45 1-1 1H6v2l-1.5-1.5L3 16v-2H1c-.55 0-1-.45-1-1V1c0-.55.45-1 1-1h10c.55 0 1 .45 1 1zm-1 10H1v2h2v-1h3v1h5v-2zm0-10H2v9h9V1z"/>
                                                                        </svg>
                                      <span class="repo-and-owner css-truncate-target">
                                        <span class="owner css-truncate-target" title="tongange">tongange</span>/<span class="repo" title="JavaEE7Tools.2016.10">JavaEE7Tools.2016.10</span>
                                      </span>
                                      <span class="stars">
                                        0
                                        <svg aria-label="stars" class="octicon octicon-star" height="16" role="img" version="1.1" viewBox="0 0 14 16" width="14">
                                            <path fill-rule="evenodd" d="M14 6l-4.9-.64L7 1 4.9 5.36 0 6l3.6 3.26L2.67 14 7 11.67 11.33 14l-.93-4.74z"/>
                                                                ...
                                                                <li class="public source ">
                                                                    <a href="/tongange/JavaEE67_libs" class="mini-repo-list-item css-truncate" data-ga-click="Dashboard, click, Popular repos list item - context:user visibility:public fork:false">
                                                                        <svg aria-label="Repository" class="octicon octicon-repo repo-icon" height="16" role="img" version="1.1" viewBox="0 0 12 16" width="12">
                                                                            <path fill-rule="evenodd" d="M4 9H3V8h1v1zm0-3H3v1h1V6zm0-2H3v1h1V4zm0-2H3v1h1V2zm8-1v12c0 .55-.45 1-1 1H6v2l-1.5-1.5L3 16v-2H1c-.55 0-1-.45-1-1V1c0-.55.45-1 1-1h10c.55 0 1 .45 1 1zm-1 10H1v2h2v-1h3v1h5v-2zm0-10H2v9h9V1z"/>
                                                                        </svg>
                                      <span class="repo-and-owner css-truncate-target">
                                        <span class="owner css-truncate-target" title="tongange">tongange</span>/<span class="repo" title="JavaEE67_libs">JavaEE67_libs</span>
                                      </span>
                                      <span class="stars">
                                        0
                                        <svg aria-label="stars" class="octicon octicon-star" height="16" role="img" version="1.1" viewBox="0 0 14 16" width="14">
                            ...
                            <%--  <div class="more-repos">
                                  <a href="/dashboard/ajax_contributed_repos?limit=7" class="more-repos-link js-more-repos-link" data-ga-click="Dashboard, click, Ajax more contributed repos link - context:user">Show 2 more repositories…</a>
                              </div>--%>
                        </div>
                    </div>
                        ...
                        <div class="boxed-group-inner">
                            <div class="filter-repos filter-bar" role="search">
                                ...
                                <ul class="repo-filterer">
                                    <li>
                                        <button type="button" class="btn-link repo-filter text-small text-gray js-repo-filter-tab filter-selected" data-filter=".public, li.private" data-ga-click="Dashboard, click, Repo list filter - context:user filter:all">All</button>
                                    </li>
                                    <li>
                                        <button type="button" class="btn-link repo-filter text-small text-gray js-repo-filter-tab" data-filter=".public" data-ga-click="Dashboard, click, Repo list filter - context:user filter:public">Public</button>
                                    </li>
                                    <li>
                                        <button type="button" class="btn-link repo-filter text-small text-gray js-repo-filter-tab" data-filter=".private" data-ga-click="Dashboard, click, Repo list filter - context:user filter:private">Private</button>
                                    </li>
                                    <li>
                                        <button type="button" class="btn-link repo-filter text-small text-gray js-repo-filter-tab" data-filter=".source" data-ga-click="Dashboard, click, Repo list filter - context:user filter:sources">Sources</button>
                                    </li>
                                    <li>
                                        <button type="button" class="btn-link repo-filter text-small text-gray js-repo-filter-tab" data-filter=".fork" data-ga-click="Dashboard, click, Repo list filter: forks">Forks</button>
                                    </li>
                                </ul>
                            </div>
                            <ul id="repo_listing" class="mini-repo-list js-repo-list" data-filterable-for="your-repos-filter" data-filterable-type="substring">
                                <li class="public source">
                                    <a class="mini-repo-list-item css-truncate" href="/SessionFactory/php_zghbh" data-ga-click="Dashboard, click, Repo list item click - context:user visibility:public fork:false">
                                        <svg aria-hidden="true" class="octicon octicon-repo repo-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12">
                                            <path fill-rule="evenodd" d="M4 9H3V8h1v1zm0-3H3v1h1V6zm0-2H3v1h1V4zm0-2H3v1h1V2zm8-1v12c0 .55-.45 1-1 1H6v2l-1.5-1.5L3 16v-2H1c-.55 0-1-.45-1-1V1c0-.55.45-1 1-1h10c.55 0 1 .45 1 1zm-1 10H1v2h2v-1h3v1h5v-2zm0-10H2v9h9V1z"/>
                                        </svg>
      <span class="repo-and-owner css-truncate-target" title="SessionFactory/php_zghbh">
        <span class="repo">php_zghbh</span>
      </span>
                                    </a>
                                </li>
                                <li class="public source">
                                    <a class="mini-repo-list-item css-truncate" href="/SessionFactory/zghbh" data-ga-click="Dashboard, click, Repo list item click - context:user visibility:public fork:false">
                                        <svg aria-hidden="true" class="octicon octicon-repo repo-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12">
                                            <path fill-rule="evenodd" d="M4 9H3V8h1v1zm0-3H3v1h1V6zm0-2H3v1h1V4zm0-2H3v1h1V2zm8-1v12c0 .55-.45 1-1 1H6v2l-1.5-1.5L3 16v-2H1c-.55 0-1-.45-1-1V1c0-.55.45-1 1-1h10c.55 0 1 .45 1 1zm-1 10H1v2h2v-1h3v1h5v-2zm0-10H2v9h9V1z"/>
                                        </svg>
      <span class="repo-and-owner css-truncate-target" title="SessionFactory/zghbh">
        <span class="repo">zghbh</span>
      </span>
                                    </a>
                                </li>
                                <li class="public source">
                                    <a class="mini-repo-list-item css-truncate" href="/SessionFactory/destoon7" data-ga-click="Dashboard, click, Repo list item click - context:user visibility:public fork:false">
                                        <svg aria-hidden="true" class="octicon octicon-repo repo-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12">
                                            <path fill-rule="evenodd" d="M4 9H3V8h1v1zm0-3H3v1h1V6zm0-2H3v1h1V4zm0-2H3v1h1V2zm8-1v12c0 .55-.45 1-1 1H6v2l-1.5-1.5L3 16v-2H1c-.55 0-1-.45-1-1V1c0-.55.45-1 1-1h10c.55 0 1 .45 1 1zm-1 10H1v2h2v-1h3v1h5v-2zm0-10H2v9h9V1z"/>
                                        </svg>
      <span class="repo-and-owner css-truncate-target" title="SessionFactory/destoon7">
        <span class="repo">destoon7</span>
      </span>
                                    </a>
                                </li>
                                <li class="public source">
                                    <a class="mini-repo-list-item css-truncate" href="/SessionFactory/sitc7" data-ga-click="Dashboard, click, Repo list item click - context:user visibility:public fork:false">
                                        <svg aria-hidden="true" class="octicon octicon-repo repo-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12">
                                            <path fill-rule="evenodd" d="M4 9H3V8h1v1zm0-3H3v1h1V6zm0-2H3v1h1V4zm0-2H3v1h1V2zm8-1v12c0 .55-.45 1-1 1H6v2l-1.5-1.5L3 16v-2H1c-.55 0-1-.45-1-1V1c0-.55.45-1 1-1h10c.55 0 1 .45 1 1zm-1 10H1v2h2v-1h3v1h5v-2zm0-10H2v9h9V1z"/>
                                        </svg>
      <span class="repo-and-owner css-truncate-target" title="SessionFactory/sitc7">
        <span class="repo">sitc7</span>
      </span>
                                    </a>
                                </li>
                                <li class="public source">
                                    <a class="mini-repo-list-item css-truncate" href="/SessionFactory/JavaEE67BaseTools" data-ga-click="Dashboard, click, Repo list item click - context:user visibility:public fork:false">
                                        <svg aria-hidden="true" class="octicon octicon-repo repo-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12">
                                            <path fill-rule="evenodd" d="M4 9H3V8h1v1zm0-3H3v1h1V6zm0-2H3v1h1V4zm0-2H3v1h1V2zm8-1v12c0 .55-.45 1-1 1H6v2l-1.5-1.5L3 16v-2H1c-.55 0-1-.45-1-1V1c0-.55.45-1 1-1h10c.55 0 1 .45 1 1zm-1 10H1v2h2v-1h3v1h5v-2zm0-10H2v9h9V1z"/>
                                        </svg>
      <span class="repo-and-owner css-truncate-target" title="SessionFactory/JavaEE67BaseTools">
        <span class="repo">JavaEE67BaseTools</span>
      </span>
                                    </a>
                                </li>
...
<%--<div class="container site-footer-container">
    <div class="site-footer" role="contentinfo">
        ...
        <ul class="site-footer-links">
            <li>&copy; 2016 <span title="0.09760s from github-fe164-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
