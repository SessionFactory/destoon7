...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <meta name="request-id" content="DFA65623:3209:11C11255:582C118E" data-pjax-transient>
    ...
    <meta content="DFA65623:3209:11C11255:582C118E" name="octolytics-dimension-request_id"/>
    <meta content="true" data-pjax-transient="true" name="analytics-location-query-strip"/>
    <meta class="js-ga-set" name="dimension1" content="Logged Out">
    <meta name="hostname" content="github.com">
    <meta name="user-login" content="">
    <meta name="expected-hostname" content="github.com">
    <meta name="js-proxy-site-detection-payload" content="OGZmMDhhZGY2OGMyMTg3NzBkZTgyMDA5NDBkMTdkMjE2ZjBmNjQwYzhkMmM4YzFlZDQwY2E2NjZmOTc1NjhiZHx7InJlbW90ZV9hZGRyZXNzIjoiMjIzLjE2Ni44Ni4zNSIsInJlcXVlc3RfaWQiOiJERkE2NTYyMzozMjA5OjExQzExMjU1OjU4MkMxMThFIiwidGltZXN0YW1wIjoxNDc5MjgzMDg4LCJob3N0IjoiZ2l0aHViLmNvbSJ9">
    <link rel="mask-icon" href="https://assets-cdn.github.com/pinned-octocat.svg" color="#4078c0">
    <link rel="icon" type="image/x-icon" href="https://assets-cdn.github.com/favicon.ico">
    <meta name="html-safe-nonce" content="51e1ef870ab2a50eced52b456dd15fa33ae7edc0">
    <meta content="f607c406ec164be091e816bebd62d57034a5d1e9" name="form-nonce"/>
...
<script type="text/javascript">
    var login = destoonBasePath + "member/";
...
<body class="logged-out  env-production windows  session-authentication page-responsive min-width-0" id="_body">
...
<div class="header header-logged-out width-full pt-5 pb-4" role="banner">
    <div class="container clearfix width-full">
        <a class="header-logo" aria-label="Homepage" data-ga-click="(Logged out) Header, go to homepage, icon:logo-wordmark">
...
<div role="main">
    ...
    <div>
        <div class="auth-form px-3" style="width: 500px;">
            <%--<!-- '"` --><!-- </textarea></xmp> --></option></form>--%>
            <form id="frm_memberLogin">
                <div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;"/>
                    <input name="authenticity_token" type="hidden"
                           value="hhk0X1gFADqCIQ2nkknJjEwr4jhzzR0uXk1asnI/6WGLqValRWZWyWHXEz7m0qZ2zP9tvKddlAjQs3o6uTpNkA=="/></div>
                ...
                <div class="auth-form-body mt-3">
                    ...
                    <input autocapitalize="off" autocorrect="off" autofocus="autofocus"
                           class="form-control input-block" id="memberLoginName" name="memberLoginName" tabindex="1" type="text"
                           placeholder="用户名"/>
                    <label for="login_field">
                        邮箱
                    </label>
                    <input autocapitalize="off" autocorrect="off" autofocus="autofocus"
                           class="form-control input-block" id="memberEmail" name="memberEmail" tabindex="1" type="text"
                           placeholder="邮箱"/>
                    <label for="password">
                        密码
                    </label>
                    <input class="form-control form-control input-block"
                           id="memberLoginPassword" name="memberLoginPassword" tabindex="2" type="password"
                           placeholder="密码"/>
                    <input class="btn btn-primary btn-block" type="button" value="登录" onclick="doLogin()"/>
                </div>
            </form>
        </div>
    </div>
